...
from openedx.core.djangoapps.notifications.notifications_config.base_notification import NotificationAppManager
...
def get_course_notification_preference_config():
    ...
    """
    app_manager = NotificationAppManager()
    course_notification_preference_config = {}
    for notification_app in app_manager.notification_apps:
        course_notification_preference_config[notification_app.name] = app_manager.get_notification_app_preferences(
...
class Notification(TimeStampedModel):
    ...
    def __str__(self):
        return f'{self.user.username} - {self.app_name} - {self.notification_type}'
